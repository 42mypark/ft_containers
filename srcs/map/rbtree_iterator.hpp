...
class rbtree_iterator {
 ...
 public:
  ...
  rbtree_iterator(const rbtree_const_iterator<value_type>& it) : current_(it.base()) {}
...
template <typename Value>
rbtree_iterator<Value> operator+(typename rbtree_iterator<Value>::difference_type n,
                                 const rbtree_iterator<Value>&                    it) {
  return it + n;
}
