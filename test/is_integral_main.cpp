...
int main() {
  ...
  ROW("signed char", std::is_integral<signed char>::value,
      ft::is_integral<signed char>::value);
  ROW("unsigned char", std::is_integral<unsigned char>::value,
      ft::is_integral<unsigned char>::value);
  ROW("char16_t", std::is_integral<char16_t>::value,
      ft::is_integral<char16_t>::value);
  ROW("char32_t", std::is_integral<char32_t>::value,
      ft::is_integral<char32_t>::value);
  ROW("int", std::is_integral<int>::value, ft::is_integral<int>::value);
  ROW("unsigned int", std::is_integral<unsigned int>::value,
  ...
  ROW("long long", std::is_integral<long long>::value,
  ...
  ROW("struct", std::is_integral<structA>::value,
      ft::is_integral<structA>::value);
}
